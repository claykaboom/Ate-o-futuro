          ...
          <div class="section profile-heading">
            <div class="columns is-mobile is-multiline">
              ...
              <div class="column is-4-tablet is-10-mobile name">
                <p>
                  <span class="title is-bold">  {{ $store.state.currentUser.displayName }} <b-tag type="is-success">Você é um(a) Expert Até o Futuro</b-tag></span>
                  <br />
                  <a
                ...
                <p class="tagline">
                  Eu ainda não tenho uma minibio! Mas estamos trabalhando nisso!
                </p>
              </div>
